...
//Para que la clase sea un controllador hay que ponerle la anotacion correspondiente
@Controller

//Todas las peticiones que terminen en / entren por aqui a traves de la siguiente anotacion
//Esta anotacion va de peticiones que implica guardar, actualizar, borrar
@RequestMapping("/")
@RequiredArgsConstructor
public class MainController {

    // 1. Metodo:devolver todos los empleados pero no una lista 
...
public String dameEmpleados(Model model) {
    ...
    //     LOG.info("ID Empleado Recido: " + idEmpleado);
    ...
    public String actualizarEmpleado(@PathVariable(name = "id", required = true)int idEmpleado, 
        ...
        //Cuando se propaga las relaciones en cascada vienen tambien los tef y los correos
    ...
    // Construir las direcciones de correos, es similar a como hemos construido
