...
public class DepartamentoServiceImpl implements DepartamentoService{
     ...
     * solamente declarando la variable de objeto y especificando el modificador final y utilizando
     * la anotacion de lombok @RequiredArgsConstructor
     **/
     ...
     //Actualmente la inyeccion de dependencia por constructor se realiza de la forma siguiente 
